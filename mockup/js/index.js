$(document).ready(function() {
    ...
    var smartSplit = function(data) {
        words = [
            "Elena first met Hernán at a bar. She was in her early twenties, hanging out in a Juárez club frequented by people involved in the drug world, people who partied hard and were always flush with cash.",
            "Elena spotted Hernán across the room and asked a friend to introduce them. She was aggressive that way. She was also strikingly attractive and had a wild streak that made her uninterested in stable men with stable careers.",
    ...
    var startFocus = function(data) {
        words = smartSplit(data); //array of paragraphs per modal
        index = 0;
        $('#myModal').modal();
